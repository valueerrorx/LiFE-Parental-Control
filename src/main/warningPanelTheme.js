...
select{padding:12px 10px;background:#f8fafc;border:1px solid var(--wp-line);border-radius:8px;
  color:#1e293b;font-size:14px;outline:none;min-width:110px}
...
.pw-wrap{position:relative;flex:1;display:flex;align-items:stretch}
